...
const BasketScreen = () => {
  ...
  const [groupedItemsItemsInBasket, setGroupedItemsItemsInBasket] = useState(
    []
  );
  ...
  useEffect(() => {
    ...
    setGroupedItemsItemsInBasket(groupedItems);
  }, [items]);
    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItemsItemsInBasket).map(([key, items]) => (
            <View
              key={key}
